...
function DEORBIT {
	...
	SET BURNTIME TO 0.
	UNTIL (0 > (TIMETODEORBITBURN - (BURNTIME*2.25))) // HACK!
	{
	...
	LOCK THROTTLE TO 0.
	UNTIL (ALTITUDE < 20000) // Still outside atmosphere...
	{
		...
		LOCAL NEWTARGETV TO SHIP:AIRSPEED * (GETGROUNDDIST(KSC) / DECISIONTRAJ[0]).
...
function GLIDE {
	...
	UNTIL ((ALT:RADAR - 5 - (0*(-SHIP:VERTICALSPEED))) < HOVERSLAMALT * 1)// - (SHIP:VERTICALSPEED*1.1))
	{
