...
function ASCEONDTOORBIT {
	...
	UNTIL (APOAPSIS > TARGETALT * 0.999 AND )
	{
		...
		LOCK THROTTLE TO (4.0-(APORATIO*4.0))+CIRCBURN.
...
UNTIL CONTINUEBURN = 0 {
	...
	SET TRAJDIST TO GETITERATEBALLX(ALTITUDE,0, CALCHORV, SHIP:VERTICALSPEED, Cd).
...
PRINT "NEWER IMPACT: " + GETITERATEBALLX(ALTITUDE,0, CALCHORV, SHIP:VERTICALSPEED, Cd) AT (0,6).
