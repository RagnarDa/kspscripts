...
function GLIDE {
	...
	UNTIL (ALT:RADAR - 5 < HOVERSLAMALT)// - (SHIP:VERTICALSPEED*1.1))
	{
		...
		SET GLIDEPATH TO ARCSIN((CURALT-500)/TARGETDIST). // HACK: Aim 500m above.
...
Assert((GETHOVERSLAMALTITUDE(100,2000,21,-20)>GETHOVERSLAMALTITUDE(100,2000,10,-20)), "Hover slam altitude 4").
